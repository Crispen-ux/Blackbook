...
const NotificationsPage = () => {
	...
	const renderRelatedPost = (relatedPost) => {
		...
		return (
			...
			>
				{relatedPost.image && (
					<img src={relatedPost.image} alt='Post preview' className='w-10 h-10 object-cover rounded text-black' />
				)}
				<div className='flex-1 overflow-hidden'>
					<p className='text-sm text-gray-800 truncate'>{relatedPost.content}</p>
				</div>
									...
									<div className='flex items-start justify-between'>
										<div className='flex items-center space-x-4'>
											<Link to={`/profile/${notification.relatedUser.username}`}>
												<img
													src={notification.relatedUser.profilePicture || "../../src/assets/avatar.png"}
