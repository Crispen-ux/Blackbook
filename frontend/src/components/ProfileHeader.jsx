				...
				<div className='text-center bg-gray-900 rounded mx-auto mb-4 pt-4 pb-6'>
					{isEditing ? (
						<input
							...
							className='text-2xl font-bold mb-2 text-center text-gray-300  bg-gray-700 rounded h-[33px] w-[300px]  border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-600'
						/>
					) : (
						<h1 className='text-2xl font-bold mb-2 mx-auto'>{userData.name}</h1>
					)}
					...
					{isEditing ? (
						<input
							...
							className='text-gray-300 text-center  bg-gray-700 rounded h-[33px] w-[300px] border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-600'
						/>
					) : (
