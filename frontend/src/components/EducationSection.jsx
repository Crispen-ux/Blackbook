			...
			{isEditing && (
				<div className='mt-4'>
					...
					<button
						...
						className='bg-teal-600 text-white py-2 px-4 rounded hover:bg-teal-300 transition duration-300 w-[200px] '
					>
						Add Education
					</button>
				</div>
			...
			{isOwnProfile && (
				<>
					{isEditing ? (
						<button
							onClick={handleSave}
							className='mt-4 bg-teal-600 text-white py-2 px-4 rounded hover:bg-teal-300 w-[200px] 
