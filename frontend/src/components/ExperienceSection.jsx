			...
			{isEditing && (
				<div className='mt-4'>
					...
					<button
						...
						className='bg-teal-600 hover:bg-teal-300 text-white py-2 px-4 rounded w-[200px]   transition duration-300'
					>
						Add Experience
					</button>
				</div>
			...
			{isOwnProfile && (
				<>
					{isEditing ? (
						<button
							onClick={handleSave}
							className='mt-4 bg-teal-600 hover:bg-teal-300 text-white py-2 px-4 rounded w-[200px]  transition duration-300'
						>
							Save Changes
						</button>
					) : (
