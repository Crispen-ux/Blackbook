...
import {
  Home, MessageSquare, Calendar, GraduationCap, Users, User, Settings, Shield, Circle, HelpCircle, Crown,
} from 'lucide-react'
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-24 bottom-0 w-64 bg-dark-2 border-r border-dark-4 overflow-y-auto">
